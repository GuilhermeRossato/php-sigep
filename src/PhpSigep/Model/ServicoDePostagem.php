...
//    const SERVICE_CARTA_REGISTRADA           = '10138';
    ...
    // CODIGOS DE SERVIÇO ADICIONADOS EM 16/08/2020
    const SERVICE_SEDEX_10_A_FATURAR = '104707';
    const SERVICE_SEDEX_HOJE_A_FATURAR = '108934';
    const SERVICE_SEDEX_12_A_FATURAR = '115218';
    const SERVICE_SEDEX_CONTRATO_GRANDES_FORMATO = '161273';
    const SERVICE_SEDEX_CONTRATO_AGENCIA_TA = '161274';
    const SERVICE_PAC_CONTRATO_AGENCIA_TA = '161277';
    const SERVICE_PAC_CONTRATO_GRANDES_FORMATOS = '161279';

    protected static $services
        = array(
            // NOVOS CODIGOS DE SERVICO DOS CORREIOS

            self::SERVICE_SEDEX_10_A_FATURAR => array("SEDEX 10 A Faturar", 104707),
            self::SERVICE_SEDEX_HOJE_A_FATURAR => array("SEDEX Hoje A Faturar", 108934),
            self::SERVICE_SEDEX_12_A_FATURAR => array("SEDEX 12 A Faturar", 115218),
